namespace MiniORM
{
    ...
    public abstract class DbContext
    {
        ...
        public void SaveChanges()
        {
            ...
            using (new ConnectionManager(_connection))
            {
                using (var transaction = _connection.StartTransaction())
                {
                    ...
                    {
                        var dbSetType = dbSet.GetType().GetGenericArguments()
                            .First();
            ...
            where TCollection : class, new ()
        {
            ...
            var foreignKey = primaryKeys.First();
            ...
            var navigationDbSet = (DbSet<TCollection>)_dbSetProperties[collectionType]
                .GetValue(this);
            ...
            where TEntity : class
        {
            ...
            var fetchedRows = _connection.FetchResultSet<TEntity>(tableName, columns)
                .ToArray();
